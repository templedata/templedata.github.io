...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1813: x0 => x0.path,
      _1840: x0 => x0.path,
      _1936: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1937: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1938: x0 => globalThis.firebase_core.getApp(x0),
      _1939: () => globalThis.firebase_core.getApp(),
      _1942: () => globalThis.firebase_core.SDK_VERSION,
      _1949: x0 => x0.apiKey,
      _1951: x0 => x0.authDomain,
      _1953: x0 => x0.databaseURL,
      _1955: x0 => x0.projectId,
      _1957: x0 => x0.storageBucket,
      _1959: x0 => x0.messagingSenderId,
      _1961: x0 => x0.measurementId,
      _1963: x0 => x0.appId,
      _1965: x0 => x0.name,
      _1966: x0 => x0.options,
      _1967: (x0,x1) => x0.createElement(x1),
      _1968: (x0,x1) => x0.debug(x1),
      _1969: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1969(f,arguments.length,x0) }),
      _1970: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1970(f,arguments.length,x0,x1) }),
      ...
      _1991: x0 => new Array(x0),
      _1993: x0 => x0.length,
      _1995: (x0,x1) => x0[x1],
      _1996: (x0,x1,x2) => x0[x1] = x2,
      _1999: (x0,x1,x2) => new DataView(x0,x1,x2),
      _2001: x0 => new Int8Array(x0),
      _2002: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _2003: x0 => new Uint8Array(x0),
      _2011: x0 => new Int32Array(x0),
      _2013: x0 => new Uint32Array(x0),
      _2015: x0 => new Float32Array(x0),
      _2017: x0 => new Float64Array(x0),
      ...
      _2052: x0 => new WeakRef(x0),
      _2053: x0 => x0.deref(),
      _2059: Date.now,
      _2061: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _2062: s => {
      ...
      _2064: () => typeof dartUseDateNowForTicks !== "undefined",
      _2065: () => 1000 * performance.now(),
      _2066: () => Date.now(),
      _2067: () => {
      ...
      _2069: () => new WeakMap(),
      _2070: (map, o) => map.get(o),
      _2071: (map, o, v) => map.set(o, v),
      _2072: () => globalThis.WeakRef,
      _2082: s => JSON.stringify(s),
      _2083: s => printToConsole(s),
      _2084: a => a.join(''),
      _2087: (s, t) => s.split(t),
      _2088: s => s.toLowerCase(),
      _2089: s => s.toUpperCase(),
      _2090: s => s.trim(),
      _2091: s => s.trimLeft(),
      _2092: s => s.trimRight(),
      _2094: (s, p, i) => s.indexOf(p, i),
      _2095: (s, p, i) => s.lastIndexOf(p, i),
      _2097: Object.is,
      _2098: s => s.toUpperCase(),
      _2099: s => s.toLowerCase(),
      _2100: (a, i) => a.push(i),
      _2104: a => a.pop(),
      _2105: (a, i) => a.splice(i, 1),
      _2107: (a, s) => a.join(s),
      _2108: (a, s, e) => a.slice(s, e),
      _2111: a => a.length,
      _2113: (a, i) => a[i],
      _2114: (a, i, v) => a[i] = v,
      _2116: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _2117: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _2118: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _2119: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _2120: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _2121: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _2122: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _2123: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _2125: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _2126: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _2127: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _2128: (t, s) => t.set(s),
      _2130: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _2132: o => o.buffer,
      _2133: o => o.byteOffset,
      _2134: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _2135: (b, o) => new DataView(b, o),
      _2136: (b, o, l) => new DataView(b, o, l),
      _2137: Function.prototype.call.bind(DataView.prototype.getUint8),
      _2138: Function.prototype.call.bind(DataView.prototype.setUint8),
      _2139: Function.prototype.call.bind(DataView.prototype.getInt8),
      _2140: Function.prototype.call.bind(DataView.prototype.setInt8),
      _2141: Function.prototype.call.bind(DataView.prototype.getUint16),
      _2142: Function.prototype.call.bind(DataView.prototype.setUint16),
      _2143: Function.prototype.call.bind(DataView.prototype.getInt16),
      _2144: Function.prototype.call.bind(DataView.prototype.setInt16),
      _2145: Function.prototype.call.bind(DataView.prototype.getUint32),
      _2146: Function.prototype.call.bind(DataView.prototype.setUint32),
      _2147: Function.prototype.call.bind(DataView.prototype.getInt32),
      _2148: Function.prototype.call.bind(DataView.prototype.setInt32),
      _2151: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _2152: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _2153: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _2154: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _2155: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _2156: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _2169: (o, t) => o instanceof t,
      _2171: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2171(f,arguments.length,x0) }),
      _2172: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2172(f,arguments.length,x0) }),
      _2173: o => Object.keys(o),
      _2174: (ms, c) =>
      ...
      _2227: (x0,x1) => x0.exec(x1),
      _2228: (x0,x1) => x0.test(x1),
      _2229: (x0,x1) => x0.exec(x1),
      _2230: (x0,x1) => x0.exec(x1),
      _2231: x0 => x0.pop(),
      _2233: o => o === undefined,
      _2252: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _2254: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _2255: o => o instanceof RegExp,
      _2256: (l, r) => l === r,
      _2257: o => o,
      _2258: o => o,
      _2259: o => o,
      ...
      _2261: o => o.length,
      _2264: (o, i) => o[i],
      _2265: f => f.dartFunction,
      _2266: l => arrayFromDartList(Int8Array, l),
      _2267: l => arrayFromDartList(Uint8Array, l),
      _2268: l => arrayFromDartList(Uint8ClampedArray, l),
      _2269: l => arrayFromDartList(Int16Array, l),
      _2270: l => arrayFromDartList(Uint16Array, l),
      _2271: l => arrayFromDartList(Int32Array, l),
      _2272: l => arrayFromDartList(Uint32Array, l),
      _2273: l => arrayFromDartList(Float32Array, l),
      _2274: l => arrayFromDartList(Float64Array, l),
      _2275: x0 => new ArrayBuffer(x0),
      _2276: (data, length) => {
      ...
      _2277: l => arrayFromDartList(Array, l),
      _2278: (s, length) => {
        if (length == 0) return '';
      ...
      _2287: (o, p) => o[p],
      _2288: (o, p, v) => o[p] = v,
      _2289: (o, m, a) => o[m].apply(o, a),
      _2291: o => String(o),
      _2292: (p, s, f) => p.then(s, f),
      _2293: o => {
      ...
      _2300: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmF32ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _2301: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _2307: x0 => x0.index,
      _2313: x0 => x0.flags,
      _2314: x0 => x0.multiline,
      _2315: x0 => x0.ignoreCase,
      _2316: x0 => x0.unicode,
      _2317: x0 => x0.dotAll,
      _2318: (x0,x1) => x0.lastIndex = x1,
      _2320: (o, p) => o[p],
      _2321: (o, p, v) => o[p] = v,
      _2322: (o, p) => delete o[p],
      _2323: v => v.toString(),
      ...
      _3770: (x0,x1) => x0.crossOrigin = x1,
      _3772: (x0,x1) => x0.text = x1,
      _4247: () => globalThis.window,
      _4574: x0 => x0.trustedTypes,
      _7029: () => globalThis.document,
      _7124: x0 => x0.head,
      _13978: () => globalThis.console,
      _14009: x0 => x0.name,
      _14010: x0 => x0.message,
      _14011: x0 => x0.code,
